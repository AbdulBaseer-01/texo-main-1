...
// ─── Mock image map (replace variantImage with a richer object if your data supports it) ───

// For now we derive mock images from the single variantImage field.
// When you update productsData, replace this with real images.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {product.variants.map((variant, i) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-2xl border border-black/10 hover:border-[#886c46]/50 transition-all duration-500"
            >
              {/* Image */}
              <div className="relative w-full aspect-4/3 overflow-hidden">
                <Image
