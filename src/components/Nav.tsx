          ...
          <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
            ...
            <nav className="hidden lg:block">
              <ul className={`${merri.className} flex items-center gap-1`}>
                ...
                <li className="group relative px-4 py-2">
                  <Link href={"/about-us"} className="text-sm font-light tracking-wide text-white transition-colors duration-300 group-hover:text-[#886c46]">
                    ABOUT US
                  </Link>
                  <span className="absolute bottom-0 left-0 h-0.5 w-0 bg-[#886c46] transition-all duration-300 group-hover:w-full" />
                </li>
                <li className="group relative px-4 py-2">
                  <Link href={"/blogs"} className="text-sm font-light tracking-wide text-white transition-colors duration-300 group-hover:text-[#886c46]">
                    BLOGS
                  </Link>
                  <span className="absolute bottom-0 left-0 h-0.5 w-0 bg-[#886c46] transition-all duration-300 group-hover:w-full" />
                </li>
