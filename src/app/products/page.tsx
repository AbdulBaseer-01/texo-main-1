...
const CategoryPage = ({
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 bg-white overflow-y-auto z-999999"
    >
      {/* ── Hero banner ── */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              {[
                ...
                <div
                  key={s.label}
                  className="rounded-2xl border border-black/8 bg-linear-to-br from-black/2 to-black/4 p-6 flex flex-col gap-1"
                >
